...
const joyful_word_scorer_1 = __importDefault(require("./claim/scorers/joyful-word-scorer"));
...
const nft_validator_1 = __importDefault(require("./claim/access-condition-validators/nft-validator"));
...
class QuestService {
    constructor({ questModel }) {
        ...
        this.accessConditionValidators.set('nft', new nft_validator_1.default());
        ...
        this.scorers = [
            ...
            new joyful_word_scorer_1.default(),
