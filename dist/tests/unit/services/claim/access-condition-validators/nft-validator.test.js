...
const nft_validator_1 = __importDefault(require("../../../../../src/services/claim/access-condition-validators/nft-validator"));
describe('NFTValidator', () => {
    let validator;
    beforeAll(() => {
        validator = new nft_validator_1.default();
    });
...
//# sourceMappingURL=nft-validator.test.js.map